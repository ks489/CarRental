...
namespace RentalCar.Service.Workflow.MyVehicleService.Activities {
    ...
    public partial class GetVehicle : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.OutArgument<RentalCar.Service.Workflow.MyVehicleService.VehicleDTO> _GetVehicleResult;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<RentalCar.Service.Workflow.MyVehicleService.VehicleDTO> GetVehicleResult {
            get {
        ...
        private string FindResource() {
            ...
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                ...
                if ((resource.Contains(".RentalCar.Service.Workflow.MyVehicleService.IVehicleService.GetVehicle.g.xaml") || resource.Equals("RentalCar.Service.Workflow.MyVehicleService.IVehicleService.GetVehicle.g.xaml"))) {
                    return resource;
                }
            }
