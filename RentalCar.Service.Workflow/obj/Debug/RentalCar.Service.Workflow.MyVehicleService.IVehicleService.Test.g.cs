...
partial void AfterInitializeComponent();
        ...
        private string FindResource() {
            ...
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                ...
                if ((resource.Contains(".RentalCar.Service.Workflow.MyVehicleService.IVehicleService.Test.g.xaml") || resource.Equals("RentalCar.Service.Workflow.MyVehicleService.IVehicleService.Test.g.xaml"))) {
                    return resource;
                }
            }
