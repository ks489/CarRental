...
namespace RentalCar.Service.Workflow.MyVehicleService.Activities {
    ...
    public partial class GetAvailableVehicles : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.OutArgument<RentalCar.Service.Workflow.MyVehicleService.VehicleDTO[]> _GetAvailableVehiclesResult;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<RentalCar.Service.Workflow.MyVehicleService.VehicleDTO[]> GetAvailableVehiclesResult {
            get {
        ...
        private string FindResource() {
            ...
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                ...
                if ((resource.Contains(".RentalCar.Service.Workflow.MyVehicleService.IVehicleService.GetAvailableVehicles" +
                        ".g.xaml") || resource.Equals("RentalCar.Service.Workflow.MyVehicleService.IVehicleService.GetAvailableVehicles." +
                        "g.xaml"))) {
                    return resource;
                }
            }
