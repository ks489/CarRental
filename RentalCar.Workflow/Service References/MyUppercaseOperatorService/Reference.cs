...
namespace RentalCar.Workflow.MyUppercaseOperatorService {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://service.bpel", ConfigurationName="MyUppercaseOperatorService.UpperOperatorPortType")]
    public interface UpperOperatorPortType {
        ...
        RentalCar.Workflow.MyUppercaseOperatorService.upperResponse upper(RentalCar.Workflow.MyUppercaseOperatorService.upperRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:upper", ReplyAction="urn:upperResponse")]
        System.Threading.Tasks.Task<RentalCar.Workflow.MyUppercaseOperatorService.upperResponse> upperAsync(RentalCar.Workflow.MyUppercaseOperatorService.upperRequest request);
    }
